...
#Feature list
feature_list = ['high_temp', 'precip_intensity',
       'description.day_of_week_Friday', 'description.day_of_week_Monday',
       'description.day_of_week_Saturday', 'description.day_of_week_Sunday',
       'description.day_of_week_Thursday', 'description.day_of_week_Tuesday',
       'description.day_of_week_Wednesday',
       'fire_department.firecares_id_74731',
       'fire_department.firecares_id_81154',
       'fire_department.firecares_id_93345',
       'fire_department.firecares_id_98606', 'month_01', 'month_02',
       'month_03', 'month_04', 'month_05', 'month_06', 'month_07', 'month_08',
       'month_09', 'month_10', 'month_11', 'month_12', 'precip_type_none',
       'precip_type_rain', 'precip_type_sleet', 'precip_type_snow',
       'holiday_Christmas', 'holiday_Christmas Eve', 'holiday_Columbus Day',
       'holiday_DST time change', 'holiday_Dr. Martin Luther King Jr.',
       'holiday_Halloween', 'holiday_July 4th', 'holiday_Labor Day',
       'holiday_MemorialDay', 'holiday_New Years Day', 'holiday_New Years Eve',
       'holiday_Presidents Day', 'holiday_Thanksgiving',
       'holiday_Veterans Day', 'holiday_none']  
